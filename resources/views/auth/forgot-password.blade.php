...
<head>
    ...
    <title>پاسورڈ بھول گئے - سیٹلمینٹ اف لینڈ ریکارڈز  دیر کلام</title>
    @php
...
<body>
    <div class="container">
        <div class="login-container">
            ...
            <h2 class="login-title">پاسورڈ بھول گئے</h2>
            <p class="login-subtitle">اپنا ای میل درج کریں تاکہ پاسورڈ ری سیٹ کا لنک حاصل کریں</p>

            <form method="POST" action="{{ route('forgot.password.post') }}">
                @csrf

                <div class="form-group">
                    <input type="email" name="email" id="email" class="form-control" placeholder="ای میل" value="{{ old('email') }}" required dir="ltr">
                </div>
                ...
                <button type="submit" class="btn-login">لنک بھیجیں</button>
            </form>
